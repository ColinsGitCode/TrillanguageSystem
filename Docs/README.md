...
学习辅助 2.0 已在全栈迁移完成后启动产品设计，当前基线为 `Features/Learning_Assistance_2_0_Design_Baseline.md`；知识图谱 2.0 已从 KG-D0 全新启动，并于 2026-07-16 确认产品定义、KG-D1 桌面原型与 KG-D2 领域数据 ADR，KG-P0 确定性识别 POC 已完成，下一门禁为 KG-P1；仍不复活旧知识 API、旧 schema 或旧页面，且不接管学习调度状态。
