...
- Features/Card_Annotation_and_Selection_UX_Evaluation.md：当前学习卡片选区与注解层专题评估。CA-P1 已完成 Radix 菜单/右键/键盘接入，CA-P2 已完成 ruby-aware selector、历史迁移与 Recogito 取舍 POC，CA-P3 已完成底层 schema/service，CA-P4 已完成受控生产迁移与三消费者 shadow read，CA-P5–P7 已切换 Cards Factory、教材课程与 Review 并保留旧 HTML 双写；本文不授权修改卡片正文；
- Architecture/Card_Annotation_Layer_ADR.md：**Accepted** 的卡片注解层技术权威。定义稳定实体身份、`card-visible-text-v1`、UTF-16 W3C quote/position selector、表 53–54、双读/compatibility write/回滚和 CA-P3–P8 顺序；CA-P7 已完成，三个消费者均以新表为读取真源，旧双写与回滚路径留到 CA-P8；
