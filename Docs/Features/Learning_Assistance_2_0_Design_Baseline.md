...
> 日期：2026-07-13
> 最近修订：2026-07-24（新场景卡固定 20 个表达，历史 12 表达卡兼容）
...
| 场景表达卡 | 整卡，或按源内容拆分（新卡 20 个；历史卡 12 个） | 整卡评分是否过粗，拆分是否造成队列膨胀 |
...
| 问题 | 当前结论 | 权威产物 |
|---|---|---|
| 三类卡的学习单元粒度 | 三语卡按 English/Japanese 拆分；语法卡整点；场景卡按实际表达拆分（新卡 20，历史卡 12） | LA-D0 §5.1 |
...
| 学习日和跨午夜 | 默认 Asia/Tokyo；事件按提交时间归属学习日 | LA-D0 §5.7；LA-D2 §7 已确认；2026-07-23 首份真实队列前完成时区修订 |
