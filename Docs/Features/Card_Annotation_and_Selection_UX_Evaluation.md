...
> 状态：**评估草稿 · 方向已确认，P1 复审已修订；迁移率 POC 已完成（§7.1，实测可重锚 96.2%）。仍待「三消费者同验 / 无头库选型 / 切换回滚」等 POC 项完成后方可进入 ADR**
>
> 日期：2026-07-23；复审修订：2026-07-26；迁移 POC：2026-07-27
>
...
| 无头菜单原语 | **包装使用** | 替换手写选区工具条的菜单/浮层/键盘/焦点;保留现有 pill 视觉与 tokens;体积由 POC gzip 量化 |
...
- [ ] **依赖体积**:无头库 + 可选 Recogito 的 JS/CSS gzip 增量;
