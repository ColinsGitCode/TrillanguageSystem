...
## 1. 语法概述（中文）
- **语法点**: 这是 E2E 测试模式下的固定语法卡内容。
- **核心结构**: 句型「${safePhrase}」在此仅作为测试占位，不代表真实语法结论。
- **使用场景**: 用于验证语法卡生成、展示与删除链路。
- **注意事项**: 不应把固定测试内容用于真实学习结论。
...
- **例句3**: 三つ目の例文で音声と表示の完全性を確認します。
  - 用第三条例句确认语音和显示的完整性。

## 3. 常见误用（中文）
- 不要把 E2E 固定句型解释当作正式语法说明。
`;
}
