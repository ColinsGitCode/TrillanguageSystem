...
const languageMetadataRuntime = require('../languageMetadata/runtime');
...
const cardGenerationPorts = {
  ...
  postProcessGeneratedContent: (content) => postProcessGeneratedContent(content, {
    removeInlineLoanwordAnnotations: LANGUAGE_METADATA_A2_ENABLED,
  }),
  validateGeneratedContent,
  resolveCardAudioTasks,
  ...
  enqueueLanguageMetadata: (generationId) => languageMetadataRuntime.enqueueGeneration(generationId),
